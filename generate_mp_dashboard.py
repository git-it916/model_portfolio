...
def main():
    workbook_path = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("mp_v2_20260515.xlsx")
    output_path = Path(sys.argv[2]) if len(sys.argv) > 2 else Path("mp_dashboard.html")
