...
def main():
    workbook_path = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("black_on_1.xlsx")
    output_path = Path(sys.argv[2]) if len(sys.argv) > 2 else Path("black_on_dashboard.html")
